function gather_separating_solutions(
    ...
    # Get data that is needed from VPCSeparator
    prlp = shared_data.prlp
    point_ray_collection = shared_data.point_ray_collection
    cut_limit = parameters.cut_limit
    max_consecutive_fail = parameters.prlp_max_consecutive_fail
    min_increase = parameters.prlp_min_increase_non_stagnating
    max_stagnating_rounds = parameters.prlp_max_consecutive_stagnation
