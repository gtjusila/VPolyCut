...
function main()
    ...
    vpcparam = VPolyhedralCut.VPCParameters(;
        ...
        time_limit = 900,
        branch_and_bound_time_limit = config["vpc_branch_and_bound_time_limit"],
        point_ray_collection_time_limit = config["vpc_point_collection_time_limit"],
        prlp_time_limit = config["vpc_prlp_time_limit"],
